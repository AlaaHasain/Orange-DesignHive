...
<div style="background-color: #f9f8ff;">
    <div class="container bg-light p-3">
        <div class="row">
            <div class="col-md-3 border-0 shadow d-flex flex-column" style="height: 80vh;">
                <div class="row">
                    ...
                    <div class="col-12 p-0 flex-grow-1" style="overflow-y: auto; max-height: calc(80vh - 60px);">
                        ...
                        <a href="{{ route('chat.index', ['receiver_id' => $user->id]) }}" class="text-decoration-none text-dark">
                            <div class="d-flex align-items-center p-2 border-bottom chat-user-item" style="cursor: pointer;">
            ...
            <div class="col-md-8 ms-5 bg-light shadow border-0 d-flex flex-column" style="height: 80vh;">
                <div class="row p-3">
                    <div class="col-12">
                ...
                <div class="flex-grow-1 p-3" id="chat-box" style="overflow-y: auto; max-height: calc(80vh - 120px);">
                    ...
                    <div class="d-flex {{ $message->sender_id == auth()->id() ? 'align-items-start justify-content-end' : 'align-items-start' }}">
                        ...
                        @endif
                        <div class="p-3 rounded-3 bg-light border-0 shadow mt-4" style="max-width: 60%;">
