                ...
                <div class="col-md-6 form-group">
                  <div class="input-group">
                    ...
                    <select name="subject" class="form-control" required="">
                      ...
                      <option value="Service 1">Design Collaboration</option>
                      <option value="Service 2">Portfolio Review</option>
                      <option value="Service 3">General Inquiry</option>
                      <option value="Service 4">Technical Support</option>
                    </select>
                  </div>
                </div>
